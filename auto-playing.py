...
tiempos = [1966,2916,2979,3033,3150,4480,5225,5237,5243,6846,7456,7513,7597,7672,7759,9135,9876,9963,9970,10077,10104,10480,10852,11664,12217,12272,12346,12406]
...
teclas = ["k","e","f","b","o","k","b","y","r","k","e","f","b","n","o","k","r","y","b","i","o","0","o","i","f","t","y","8"]
...
scale_velocity =  0.5 # 1: regular speed    0.5: double speed
